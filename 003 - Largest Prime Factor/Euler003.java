...
factors at i=1 and working upwards while checking if the corresponding factor is prime. The largest factor of a number
can be found by instead identifying the smallest factor.
