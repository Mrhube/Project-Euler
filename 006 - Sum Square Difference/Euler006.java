...
public class Euler006 {
	...
	Problem: Find the absolute difference between the sum of the squares of the first N natural numbers and the square of
	the sum.
	...
	// Could be up to 10000 test cases, so not repeating calculations will be very beneficial
	// Can use simple equation for triangular number to calculate sum of n natural numbers
